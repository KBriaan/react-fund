...
//   return (
//     <div style={bgStyle} className="h-screen overflow-hidden">
//       <div className="min-h-[650px] md:min-h-[750px] bg-gradient-to-r from-black/80 to-primary/60 pt-3 pb-10 md:pt-48">
//         <div className="container mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 text-white">
//             {/* Hero text section */}
//             <div className="flex flex-col items-center text-center gap-5 py-20 lg:items-start lg:text-left lg:max-w-[650px] lg:pb-10">
//               <motion.h1
//                 variants={FadeUp(0.2)}
//                 initial="initial"
//                 animate="animate"
...
//             {/* Form section */}
//             <div className="w-full md:w-[400px] mx-auto p-4 bg-white dark:bg-black text-black dark:text-white rounded-2xl shadow-md">
//               <div>
//                 <h1 className="text-lg text-center font-semibold">
//                   Quick Donation Form
//                 </h1>
